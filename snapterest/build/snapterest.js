    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Stream, { onAddTweetToCollection: this.addTweetToCollection, __self: this
          })
        ),
        React.createElement(
          'div',
          ...
          React.createElement(Collection, {
            ...
            onRemoveAllTweetsFromCollection: this.removeAllTweetsFromCollection, __self: this
          })
        )
      )
    );
  ...
  render: function () {
    return React.createElement(
      'button',
      {
        ...
        style: buttonStyle,
        onClick: this.props.handleClick, __self: this
      },
      this.props.label
    );
  }
...
var Collection = React.createClass({
  ...
  createHtmlMarkupStringOfTweetList: function () {
    var htmlString = ReactDOMServer.renderToStaticMarkup(React.createElement(TweetList, { tweets: this.props.tweets, __self: this
    }));
    ...
    if (numberOfTweetsInCollection > 0) {
      ...
      return React.createElement(
        ...
        React.createElement(CollectionControls, {
          ...
          onRemoveAllTweetsFromCollection: removeAllTweetsFromCollection, __self: this
        }),
        React.createElement(TweetList, {
          tweets: tweets,
          onRemoveTweetFromCollection: handleRemoveTweetFromCollection, __self: this
        })
      );
    }

    return React.createElement(Header, { text: 'Your collection is empty', __self: this
    });
  }
});
  ...
  render: function () {
    if (this.state.isEditingName) {
      return React.createElement(CollectionRenameForm, {
        ...
        onCancelCollectionNameChange: this.toggleEditCollectionName, __self: this
      });
    }
    ...
    return React.createElement(
      ...
      React.createElement(Header, { text: this.getHeaderText(), __self: this
      }),
      React.createElement(Button, {
        label: 'Rename collection',
        handleClick: this.toggleEditCollectionName, __self: this
      }),
      React.createElement(Button, {
        label: 'Empty collection',
        handleClick: this.props.onRemoveAllTweetsFromCollection, __self: this
      }),
      React.createElement(CollectionExportForm, { htmlMarkup: this.props.htmlMarkup, __self: this
      })
    );
  }
});
...
var CollectionExportForm = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'form',
      { action: 'http://codepen.io/pen/define', method: 'POST', target: '_blank', style: formStyle, __self: this
      },
      React.createElement('input', { type: 'hidden', name: 'data', value: this.props.htmlMarkup, __self: this
      }),
      React.createElement(
        'button',
...
var CollectionRenameForm = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'form',
      { className: 'form-inline', onSubmit: this.handleSubmit, __self: this
      },
      React.createElement(Header, { text: 'Collection name:', __self: this
      }),
      React.createElement(
        'div',
        ...
        React.createElement('input', {
          ...
          ref: 'collectionName', __self: this
        })
      ),
      React.createElement(Button, { label: 'Change', handleClick: this.handleFormSubmit, __self: this
      }),
      React.createElement(Button, { label: 'Cancel', handleClick: this.handleFormCancel, __self: this
      })
    );
  }
});
...
},{"./Button.react":223,"./Header.react":228,"react":206}],228:[function(require,module,exports){
var React = require('react');
  ...
  render: function () {
    ...
    if (tweet) {
      return React.createElement(StreamTweet, {
        tweet: tweet,
        onAddTweetToCollection: this.props.onAddTweetToCollection, __self: this
      });
    }

    return React.createElement(Header, { text: 'Waiting for public photos from Twitter...', __self: this
    });
  }
});
...
var StreamTweet = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(Header, { text: this.state.headerText, __self: this
      }),
      React.createElement(Tweet, {
        tweet: this.props.tweet,
        onImageClick: this.props.onAddTweetToCollection, __self: this
      })
    );
  }
});
...
var Tweet = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { style: tweetStyle, __self: this
      },
      React.createElement('img', { src: tweetMediaUrl, onClick: this.handleImageClick, style: imageStyle, __self: this
      })
    );
  }
});
...
var TweetList = React.createClass({
  ...
  getTweetElement: function (tweetId) {
    ...
    if (handleRemoveTweetFromCollection) {
      ...
      tweetElement = React.createElement(Tweet, {
        tweet: tweet,
        onImageClick: handleRemoveTweetFromCollection, __self: this
      });
    } else {
      tweetElement = React.createElement(Tweet, { tweet: tweet, __self: this
      });
    }

    return React.createElement(
      'li',
      { style: listItemStyle, key: tweet.id, className: 'col-sm-4', __self: this
      },
      tweetElement
    );
  },
  ...
  render: function () {
    ...
    return React.createElement(
      'ul',
      { style: listStyle, className: 'row', __self: this
      },
      tweetElements
    );
  }
